...
Function main()
	...
	wBase = FS.GetBaseName( FnameAddIn )
	Set wBook = XL.Workbooks.Add

'	wAddInName = FnameAddIn
	wAddInName = objEnv.Item("APPDATA") & "\Microsoft\AddIns\" & wBase & ".xla"
...
'	Set xlAddIn = XL.AddIns.Add( FnameAddIn, True )
