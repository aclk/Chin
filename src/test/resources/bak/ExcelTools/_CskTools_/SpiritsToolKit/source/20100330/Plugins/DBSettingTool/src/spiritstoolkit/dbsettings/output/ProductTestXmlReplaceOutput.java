...
public class ProductTestXmlReplaceOutput extends AbstractReplaceOutput {
    ...
    public void replaceOutput(String prjRootPath, String jdbcUrl, String user,
        String password, String schema) throws Exception {
        ...
        for (File f : files) {
            ...
            try {
                super.replaceOutput(prjRootPath, jdbcUrl, user, password,
                    schema);
            } catch (IllegalArgumentException iae) {
    			ConsoleUnit console = new ConsoleUnit();
    			console.outPutStream(iae.getMessage());
            }
        }
    }
