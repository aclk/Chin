...
class TutorialSAXHandler implements ContentHandler, ErrorHandler {
	...
	public void startElement(String uri,
		...
		if (localName.equals("tutorial")) {
			startElementTutorial(uri, localName, qName, atts);
		} else if (localName.equals("caption")) {
			startElementCaption(uri, localName, qName, atts);
		}
	}
	...
	public void endElement(String uri,
	                       ...
	                       throws SAXException {
		if (localName.equals("tutorial")) {
			endElementTutorial(uri, localName, qName);
		} else if (localName.equals("caption")) {
			endElementCaption(uri, localName, qName);
		}
	}

	// tutorial要素の出現
	private void startElementTutorial(String uri, String localName,
	...
	// tutorial要素の終了
	private void endElementTutorial(String uri, String localName,
	                                String qName)
	                                throws SAXException {
	...
	// caption要素の出現
	private void startElementCaption(String uri, String localName,
	                                 String qName, Attributes atts)
	                                 throws SAXException {
		caption = null;
		example = atts.getValue("example");
		buffer.setLength(0);
	}

	// caption要素の終了
	private void endElementCaption(String uri, String localName,
	                               String qName)
	                               throws SAXException {
		caption = buffer.toString();
		tutorialList.add(new Tutorial(caption, example));
	}
