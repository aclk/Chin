/* based on launcher for freemind */
#include <process.h> 
#include <stdlib.h>
#include <string.h>
#include <stdio.h>
...
int main(int argc, char *argv[])  { 
   ...
   char *application_name = "jRegExAnalyser.jar";
   ...
   char *position_of_last_occurrence;
   if (position_of_last_occurrence = strrchr(path_to_launcher,'\\')) {
   ...
   execvp(javaw_path, (const char* const*)arguments);

   MessageBox(0, "Error launching javaw.exe / jRegExAnalyser.jar", "Error", MB_OK|MB_ICONERROR);


   // comment kept from freemind launcher:
