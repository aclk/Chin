...
public class CrawlerConfig {
    ...
    private static final long DEFAULT_DOWNLOAD_INTERVAL = TimeUnit.HOURS
        .toMillis(1);
    ...
    public int hashCode() {
        ...
        result =
            31 * result + (int)(downloadInterval ^ (downloadInterval >>> 32));
        return result;
    }

    @Override
    public String toString() {
        return "CrawlerConfig{" + "url='" + url + '\'' + ", downloadInterval="
            + downloadInterval + '}';
    }
}
